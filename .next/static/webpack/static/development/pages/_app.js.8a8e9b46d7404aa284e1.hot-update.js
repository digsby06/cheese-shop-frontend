...
function (_App) {
  ...
  _createClass(StoreApp, [{
    ...
    value: function getCartAmount() {
      var cookieCart = js_cookie__WEBPACK_IMPORTED_MODULE_5___default.a.get('cart');
      console.log(JSON.parse(cookieCart));

      if (typeof cookieCart !== 'undefined') {
        var amount = cookieCart.reduce(function (prev, curr) {
          return prev.quantity + curr.quantity;
        }, 0);
        console.log(amount);
      }

      return _store__WEBPACK_IMPORTED_MODULE_6__["store"].cartAmount;
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, this.getCartAmount())))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: "outer"
...
//# sourceMappingURL=_app.js.8a8e9b46d7404aa284e1.hot-update.js.map